...
<div style="float: left;">
	...
	<tr><td>시작일: </td><td><input type="text" name="start_date" OnClick="Calendar(this, 'down','no');" value="2015-12-03"></td></tr>
	<tr><td>만료일: </td><td><input type="text" name="due_date" OnClick="Calendar(this, 'down','no');" value="2015-12-03"></td></tr>
	<tr><td>고객처: </td><td><input type="text" name="orderer"/></td></tr>
	<tr><td>프로젝트 설명: </td><td><textarea rows="5" cols="24" name="project_desc"></textarea></td></tr>
	...
	<tr><td>PM설정 : </td><td><select name="employee_number">
								...
								<option value="${user.employee_number}"><c:out value="${user.employee_number} ${user.getName()} ${user.getPosition()}"/></option>
								</c:forEach>
								</select></td></tr>
