...
<body style="background-color: #fafafa">
	...
	<tr><td><h4>직원 리스트:</h4> </td><td>
		<td><div class="col-xs-5"><select class="form-control"name="employee_number" placeholder="선택하세요">
	...
	<tr><td><input type="hidden" name="project_number" value="${project_number}"/></td>
		<td><button type="submit" class="btn btn-default" value="투출">투출</button></td></tr>
	</table>
	</form>
