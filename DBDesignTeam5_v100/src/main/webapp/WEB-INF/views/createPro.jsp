...
<body style="background-color: #fafafa">
	...
	<tr><td><h5>시작일:</h5> </td><td><div class="col-xs-3"><input type="text" class="form-control"name="start_date" OnClick="Calendar(this, 'down','no')" value="2015-12-03"></div></td></tr>
	<tr><td><h5>만료일:</h5> </td><td><div class="col-xs-3"><input type="text" class="form-control"name="due_date" OnClick="Calendar(this, 'down','no')" value="2015-12-03"></div></td></tr>
	<tr><td><h5>고객처:</h5> </td><td><div class="col-xs-3"><input type="text" class="form-control"name="orderer"/></div></td></tr>
	<tr><td><h5>프로젝트 설명:</h5> </td><td><div class="col-xs-8"><textarea rows="5" cols="24" class="form-control"name="project_desc"></textarea></div></td></tr>
	<tr><td><h5>기획자 :</h5> </td><td>${session.employee_number}<input type="hidden" class="form-control"name="constructor_number" value="${session.employee_number}"/></td></tr>
	<tr><td><h5>PM설정 :</h5> </td><td><div class="col-xs-3"><select name="employee_number">
								<c:forEach items="${developer}" var="user">
								<option class="form-control"value="${user.employee_number}"><c:out value="${user.employee_number} ${user.getName()} ${user.getPosition()}"/></option>
								</c:forEach>
								</select></div></td></tr>
