...
<body style="background-color: #fafafa">
	...
	<div class="col-md-9">
	<h2>평가하기</h2>
	<h3>${message}</h3><!-- 평가완료시/실패시 나타나는 message box -->
	...
	<c:forEach items="${list}" var="result">
			...
			<tr><td><h5>평가종류</h5></td>
				<td><div class="col-xs-4"><select name="eval_type"class="form-control" >
			...
			<tr><td><h5>비즈니스 평가</h5></td>
				<td><div class="col-xs-3"><input type="text" class="form-control" name="business_eval"/></div></td></tr>
	...
	<tr><td><button type="submit" class="btn btn-default" value="제출" onclick="constraint(); return false;">제출</button>  
	 <input type="button" class="btn btn-default" value="홈으로" onclick="history.go(-1)"/></td></tr>
	</table>
	</form>
	</div>
	</div>
